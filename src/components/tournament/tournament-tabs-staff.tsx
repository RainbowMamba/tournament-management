...
import { CourtViewStaff } from "./court-view-staff";
import { DrawViewStaff } from "./draw-view-staff";
...
export function TournamentTabsStaff({ tournament }: Props) {
  ...
  return (
    <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
      ...
      <TabsContent value="court">
        <CourtViewStaff tournament={tournament} />
      </TabsContent>
